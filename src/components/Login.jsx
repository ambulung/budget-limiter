...
const Login = ({ onLogin }) => {
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      <div className="bg-white dark:bg-gray-800 p-10 rounded-xl shadow-2xl text-center">
        <h1 className="text-4xl font-bold mb-2 text-gray-800 dark:text-gray-100">Budget Limiter</h1>
        <p className="text-gray-600 dark:text-gray-400 mb-8">Sign in to take control of your spending.</p>
        <button
          onClick={onLogin}
          className="flex items-center justify-center gap-3 w-full px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 transition-all duration-300"
        >
