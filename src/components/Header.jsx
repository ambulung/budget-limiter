...
// MODIFIED: Removed appTitle and appIcon from props
  ...
  return (
    <header className="bg-[#1C2135] dark:bg-gray-900 shadow-md sticky top-0 z-40">
      <nav className="max-w-5xl mx-auto px-4 md:px-8">
        <div className="flex items-center justify-end h-16"> {/* MODIFIED: Changed justify-between to justify-end */}
          {/* --- REMOVED: appIcon and appTitle container --- */}
